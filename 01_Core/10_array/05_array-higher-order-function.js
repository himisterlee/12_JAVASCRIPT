...
// 짝수 판별
const even = nembers.filter(item => item % 2 === 0)
...
console.log(result); // false
result = arr1.som(imtem => item === 'dog')
console.log(result); // true


console.log('-------------every-------------');

// Array.prototype.every : 배열내 모든 요소가 콜백함쉬의 테스트를 통과하는지 확인 (Boolean)
...
// 배열을 순회하며 각 요소에 대해 인자로 주어진 콜백함수를 실행 그결과가 참인 첫번째 요소를 반환
// 만약, 참인 요소가 존재하지 않으면 undefinde
// Array.prototype.findIndex : 
// 배열을 순회하며 각 요소에 대해 인자로 주어진 콜백함수를 실행 그결과가 참인 첫번째 요소의 이덱스를 반환
